package com.xstudy.content.generator;
...
//			 "course_publish_pre"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/xstudy-generator/src/main/java");
		gc.setAuthor("summery");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/xstudy_" + SERVICE_NAME
